...
devtools::build_vignettes('vignette_name')
...
1) **[Create a git repo](https://kbroman.org/github_tutorial/pages/init.html)**   
2) Commit all of your changes locally   
3) Connect and push to the repository by doing   
``` {r, echo=TRUE, eval=FALSE}
